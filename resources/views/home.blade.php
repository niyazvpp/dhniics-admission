...
<head>
    ...
    $description = 'Official Website of Darul Huda Islamic University Bengal Campus. DHIU was established as an
    ...
    if (empty($title)) {
    $title = 'Darul Huda Bengal Campus';
    } else $title .= ' | Darul Huda Bengal Campus';
    ...
    <meta name="keywords" content="Darul Huda, Bengal Campus, dhiu, Kerala, Islamic University, Admission Portal">
...
<body class="w-screen h-screen overflow-hidden bg-cover" style="background-image: url({{ asset('img/campus.jpg') }});">
    ...
    <div class="flex items-center justify-center w-screen h-screen p-4 overflow-hidden bg-black bg-opacity-70">
        <div class="text-center text-white">
            <h1 class="mb-8 text-4xl font-bold uppercase">Welcome to <br>Darul Huda Bengal Campus</h1>
            <div class="mb-4 text-xl font-medium">Results of Admission 2023 - 24 is out!</div>
    ...
    <div class="flex items-center justify-center w-screen h-screen p-4 overflow-hidden bg-black bg-opacity-70">
        <div class="text-center text-white">
            <h1 class="mb-8 text-4xl font-bold uppercase">Welcome to <br>Darul Huda Bengal Campus</h1>
            <div class="mb-4 text-xl font-medium">Admission to 2023 - 24 is open!</div>
            <a class="px-4 py-2 mt-6 text-white bg-white border-2 border-white hover:bg-opacity-10 rounded-xl bg-opacity-5"
