...
<nav x-cloak x-data="{ open: false, dropdown: false }" class="mb-4 bg-gray-800">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div class="relative ml-3">
                    <div>
                        <button @click.away="dropdown = false" @click="dropdown = !dropdown" type="button"
                            ...
                            <img class="w-8 h-8 rounded-full" src="{{ asset('img/user.png') }}" alt="">
                        </button>
                    </div>
